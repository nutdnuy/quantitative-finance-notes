...
## Welcome — New York Stock Exchange photograph

`assets/images/welcome-nyse.jpg`: *Manhattan – New York Stock Exchange Building* by **Skypetrus (Piotr M. Kazimierczak)**, via [Wikimedia Commons](https://commons.wikimedia.org/wiki/File:Manhattan_-_New_York_Stock_Exchange_Building_-_20190929151052.jpg), licensed under [Creative Commons Attribution–ShareAlike 4.0 International](https://creativecommons.org/licenses/by-sa/4.0/). The site distributes Wikimedia's 1280px thumbnail unchanged; the browser scales it proportionally, without cropping or recoloring. This image remains under CC BY-SA 4.0. Use does not imply the photographer's or exchange's endorsement. Source, dimensions, and SHA-256 are recorded in `data/welcome-photo-provenance.json`, with visible credit beneath the photograph.
