...
ใช้ความรู้เรื่อง [Returns](prices-and-returns.html), ค่าเฉลี่ย, ส่วนเบี่ยงเบนมาตรฐาน และเส้นถดถอยเชิงเส้นประกอบได้ ตัวเลข A/B และผลทดลองในซีรีส์เป็นข้อมูลสมมติทั้งหมด ไม่มีคู่หุ้นแนะนำหรือผล Backtest ของตลาดจริง
