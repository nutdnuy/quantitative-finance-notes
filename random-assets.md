...
ถ้าให้ผมบอกว่าทำไมเราต้องเรียนเรื่องความสุ่ม ผมอยากเริ่มจากคำถามง่าย ๆ ก่อนว่า ราคาที่เห็นอยู่บนหน้าจอหนึ่งตัว เกิดจากอะไรบ้าง?
...
ในจังหวะที่คนหนึ่งยอมซื้อ อีกคนก็ยอมขาย เราเห็นราคาเดียวกันได้ แต่มีความคาดหวัง เหตุผล และข้อจำกัดต่างกัน การจะรวบรวมทุกปัจจัยเพื่อบอกล่วงหน้าว่าราคาต้องไปอยู่ตรงไหนจึงเป็นโจทย์ที่ยากมาก

นี่คือประเด็นที่ **Louis Bachelier** ตั้งไว้ในงาน *Théorie de la spéculation* เมื่อปี **1900** แล้วพาไปสู่คำถามที่น่าสนใจกว่า: ถ้าเราไม่รู้ว่าราคาจะเคลื่อนไปทางไหนแน่ ๆ เราจะอธิบายได้ไหมว่า การเคลื่อนไหวแต่ละแบบมีโอกาสเกิดมากน้อยแค่ไหน? [อ่านงานต้นฉบับของ Bachelier](https://www.numdam.org/item/ASENS_1900_3_17__21_0/)

**การใช้คณิตศาสตร์ศึกษาความเป็นไปได้ของราคา คือหนึ่งในรากฐานสำคัญของการเงินเชิงปริมาณ หรือ Quant** งานของ Bachelier เป็นหมุดหมายแรก ๆ ของการนำความน่าจะเป็นมาศึกษาราคาและสัญญาออปชันอย่างเป็นระบบ แนวคิดนี้ยังต้องอาศัยสมมติฐานและการตรวจสอบกับข้อมูล เราไม่ได้รู้อนาคตเพียงเพราะเขียนมันออกมาเป็นสมการ

สำหรับบทนี้ ผมอยากให้จับวิธีคิดนี้ให้ได้ก่อน แล้วค่อยต่อยอดไปสู่แบบจำลองราคาที่มีทั้งการเปลี่ยนแปลงเฉลี่ยและส่วนสุ่ม
...
ลองสมมติว่าเราประเมินหุ้นตัวหนึ่งไว้ที่ 80 บาท แต่ตลาดซื้อขายกันอยู่ที่ 60 บาท ดูเหมือนมีส่วนต่างให้เราแล้วใช่ไหม? ปัญหาคือ 80 บาทนั้นยังเป็นผลจากสมมติฐานของเรา ถ้ายอดขายไม่โตตามที่คิด หรือบริษัทต้องลงทุนมากกว่าที่คาด มูลค่าที่คำนวณได้ก็เปลี่ยน
...
แต่การเห็นรูปแบบบนกราฟยังไม่ตอบว่ามันใช้ตัดสินใจได้ดีแค่ไหน ถ้าจะเอาไปใช้ เราต้องบอกให้ชัดว่าตอนไหนถือว่าเกิดสัญญาณ เข้าหรือออกอย่างไร แล้วทดสอบกับข้อมูลที่ไม่ได้ใช้คิดกฎนั้นขึ้นมา รวมค่าธรรมเนียมและต้นทุนซื้อขายด้วย

ผมอยากให้แยกสองเรื่องนี้ออกจากกัน: เราอธิบายกราฟย้อนหลังได้ กับเรามีกฎที่ยังใช้ได้เมื่อเจอข้อมูลใหม่ การทดสอบจะช่วยให้เห็นว่าหลักฐานรองรับสิ่งที่เราคิดมากน้อยแค่ไหน

### การวิเคราะห์เชิงปริมาณ — Quantitative analysis

สำหรับ Quant เราพยายามทำคำถามให้ชัดพอที่จะวัดและตรวจสอบได้ ใช้ข้อมูล คณิตศาสตร์ และสถิติมาสร้างแบบจำลอง แล้วดูว่าคำตอบเปลี่ยนอย่างไรเมื่อสมมติฐานเปลี่ยน
...
ในบทนี้เราจะเริ่มจาก **แบบจำลองความสุ่มของราคา** ดูทั้งค่าเฉลี่ย ขนาดการกระจาย และผลของเวลา พอจับเรื่องนี้ได้ เราจะเห็นว่าทำไมการรู้ราคาเฉลี่ยเพียงตัวเดียวจึงยังไม่พอสำหรับการกำหนดราคา Option
...
Option หรือออปชัน คือสัญญาที่ให้ผู้ถือมี **สิทธิ แต่ไม่มีข้อผูกมัดว่าต้องใช้สิทธิ** ในการซื้อหรือขายสินทรัพย์ตามราคาและเงื่อนไขที่ตกลงกัน สิทธิซื้อเรียกว่า **Call option** ส่วนสิทธิขายเรียกว่า **Put option** ผู้ซื้อจ่ายเงินเพื่อให้ได้สิทธินี้ เงินนั้นเรียกว่า **premium** หรือราคาออปชัน
...
- Paul Wilmott (2006), *Paul Wilmott on Quantitative Finance*, 2nd ed., บท 3 หน้า 55–70: เนื้อหาที่นำมาแปลและเรียบเรียง สมการ และตัวอย่าง 50/150; ข้อมูล Perez Companc และกองทุนเป็นข้อมูลประวัติศาสตร์ตามหนังสือ
