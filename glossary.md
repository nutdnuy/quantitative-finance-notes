...
หน้านี้รวมศัพท์ที่เราใช้ในบทเรียน **พฤติกรรมแบบสุ่มของสินทรัพย์** เอาไว้เปิดเทียบระหว่างอ่าน เริ่มจากความหมายที่จำเป็นในบทนี้ก่อน แต่ละคำมีลิงก์กลับไปดูตัวอย่างและภาพทดลองที่เกี่ยวข้อง
